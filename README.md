...
<sub>Every graphic here is hand written SVG, generated by <code>build.py</code> in this repo. No third party stat widgets. The heatmap is my real GitHub calendar, pulled fresh by <code>refresh.py</code> and a daily GitHub Action, so these numbers are never stale.</sub>
